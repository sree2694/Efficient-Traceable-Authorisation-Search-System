...
<div style="width: 1000px; height: auto; margin-top: -15px;">
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     %>
   <center><h1><font style="color: rgb(0, 0, 136)" face="Algerian">View Requested Files</font></h1></center>
...
<table border='1px' align='center' bordercolor="black" width="892" height="170">
...
<font color="green"><%=pb.getFilename()%></font>
 ...
 <td>
<font color="green"><a href="Cloudfileacceptservlet?id=<%=pb.getFileid() %>">Accept</a></font>
</td>
