...
<div style="width: 1000px; height: auto; margin-top: -15px;">
			...
			<br/><br/>
			<h2><font color=green>ENTER OTP HERE</font></h2>   
			<center>
			
		<form action="Otpcheckservlet"  onsubmit="return validator();">
                <table border="0"  style="" width="305px"  >   
                	...
                	<tr>
                         <td><input type="hidden" name="fileid" id="uid" class="input_text"  value="<%=request.getParameter("id")%>" />
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
                      
                        </td>
                        </tr>
                        <tr>
                         <td><input type="hidden" name="ownername" id="uid" class="input_text"  value="<%=request.getParameter("ownername")%>"/>
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
                    ...
                    <tr>
                        <td>ENTER OTP: <span class="dot"></span></td>
                        <td><input type="text" name="otp" id="uid" class="input_text"  value="" placeholder="Please Enter Valid OTP" autofocus/>
                         <label id="msguid"  style="color: red;font-size: 16px;font-style: italic;"></label>
