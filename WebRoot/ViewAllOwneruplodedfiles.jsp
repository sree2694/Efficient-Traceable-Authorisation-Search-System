...
<div style="width: 1000px; height: auto; margin-top: -15px;">
			...
			<div style="margin-top: -3px;"><jsp:include page="DataOwnerMenu.jsp"></jsp:include></div>
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     %>
   <center><h1><font style="color: rgb(0, 0, 136)" face="Algerian">View All Uploaded Files</font></h1></center>
<table border='1px' align='center' bordercolor="black" height="50" width="450">
<tr>
...
<td align="center">
 ...
 <td align="center">
<font color="green"><%=pb.getStatus()%></font>
 </td>
