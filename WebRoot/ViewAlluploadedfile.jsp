...
<font color="green"><%=pb.getFilename()%></font>
 ...
 <td>
<font color="green"><a href="RequestsendtokgcServlet?id=<%=pb.getFileid() %>&username=<%=pb.getUsername()%>&mail=<%=pb.getEmail()%>&mobile=<%=pb.getMobileno()%>&filename=<%=pb.getFilename()%> ">Request</a></font>
</td>
