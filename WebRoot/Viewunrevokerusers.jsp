...
<div style="width: 1000px; height: auto; margin-top: -15px;">
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list");
     %>
   <center><h1><font style="color: rgb(0, 0, 136)" face="Algerian">View Requested Users</font></h1></center>
...
<font color="green"><%=pb.getAddress()%></font>
 ...
 <td>
<font color="green"><a href="UnrevokeRequestAcceptServlet?id=<%=pb.getLoginid() %>">Accept</a></font>
</td>
