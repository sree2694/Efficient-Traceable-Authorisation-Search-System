...
public class KgcLogindao extends DbCon {

	
	public ArrayList<Profilebean> kgclogin(Profilebean pb) {
...
/*System.out.println("*******connection*********"+con);*/
	...
	try {
		PreparedStatement ps=con.prepareStatement("select role,username from USERDETAILS where user_id=? and password=?");
		ps.setString(1, uid);
